...
import { getAllPosts, getSemanticPost, getSpecificPost, uploadPost } from '../controllers/postController';
...
router.get('/semanticSearchPosts', authorizeAccount, getSemanticPost)
