import type { SemanticPostsSummary_Interface } from "../../../configs/types_and_interfaces"

type TailoredPostsProviderProps = {
    post: SemanticPostsSummary_Interface
}

const TailoredPostsSummary = ({post}: TailoredPostsProviderProps) => {
    return (
		<div key={post._id} className="flex flex-col h-full">
            <div className='w-full min-h-[70%] max-h-[70%] flex-1 flex box-border px-4'>
                <p className='h-[98%] w-full line-clamp-16 text-[0.9rem]'>
                    {post.description}
                </p>
            </div>
            <div className='w-full h-[30%] flex-1 grid grid-cols-3 grid-rows-4 place-items-center box-border text-[0.9rem] p-1 cursor-default'>
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-60%] left-[-350%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-3 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-60%] left-[-470%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-50%] left-[-585%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-150%] left-[-350%] w-[20rem] h-fit  items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-150%] left-[-470%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-200%] left-[-585%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-250%] left-[-350%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-300%] left-[-470%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-250%] left-[-585%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-400%] left-[-350%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-400%] left-[-470%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-450%] left-[-585%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center'>
...
export default TailoredPostsSummary
