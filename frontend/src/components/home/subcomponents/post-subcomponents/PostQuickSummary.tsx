...
const PostQuickSummary = () => {
    return (
        <>
            <div className='w-full h-[70%] flex-1 flex box-border px-4'>
                <p className='h-[94%] w-full line-clamp-16 text-[0.9rem]'>
            ...
            <div className='w-full h-[30%] flex-1 grid grid-cols-3 grid-rows-4 place-items-center box-border text-[0.9rem] p-1'>
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[0.2rem] left-[-21.6rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[0.2rem] left-[-28.45rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[0.2rem] left-[-35.4rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-2.1rem] left-[-21.6rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-2.1rem] left-[-28.45rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-2.1rem] left-[-35.35rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-4.4rem] left-[-21.6rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-4.4rem] left-[-28.45rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-4.4rem] left-[-35.4rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-6.7rem] left-[-21.65rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-6.7rem] left-[-28.45rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-6.7rem] left-[-35.35rem] w-[21.15rem] h-[9rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl'>
