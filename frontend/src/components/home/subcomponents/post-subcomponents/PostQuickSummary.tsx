        ...
        <div key={post._id} className="flex flex-col h-full">
            ...
            <div className='w-full h-[30%] flex-1 grid grid-cols-3 grid-rows-4 place-items-center box-border text-[0.9rem] p-1 cursor-default'>
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[1%] left-[-365%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-3 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[1%] left-[-490%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[1%] left-[-615%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-100%] left-[-365%] w-[20rem] h-fit  items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-100%] left-[-490%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-180%] left-[-615%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-250%] left-[-365%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-300%] left-[-490%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-250%] left-[-615%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-400%] left-[-365%] w-[20rem] h-fit items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-400%] left-[-490%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
                ...
                <div className='w-[6.5rem] h-[2rem] flex items-center justify-center rounded-3xl box-border p-1 border-2 border-red-500 relative group'>
                    ...
                    <div className='absolute bg-black/70 top-[-450%] left-[-615%] w-[20rem] h-fit max-h-[10rem] items-center box-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-xl text-center pointer-events-none'>
